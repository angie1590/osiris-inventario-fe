...
const schema = z.object({
  isbn: z.string().min(10, 'Mínimo 10 caracteres').max(32, 'Máximo 32 caracteres').optional(),
  ...
  const body = (
    <>
      ...
      <Section title="Información general">
        <FormField label="ISBN" error={errors.isbn?.message} hint="Si no lo envías, el backend generará un código automático.">
          <Input {...register('isbn')} placeholder="9780000000000" />
        </FormField>
