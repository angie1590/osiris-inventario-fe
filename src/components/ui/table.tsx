...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-[hsl(var(--table-head))] [&_tr]:border-b [&_tr]:border-border",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn(
      "[&_tr:nth-child(even)]:bg-[hsl(var(--table-row-alt))] [&_tr:last-child]:border-0",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border/70 transition-colors hover:bg-accent/65 data-[state=selected]:bg-accent",
      className,
    )}
    {...props}
  />
