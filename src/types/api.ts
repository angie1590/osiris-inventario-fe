...
export type AttributeDataType = 'text' | 'integer' | 'decimal' | 'date' | 'boolean' | 'select'
...
export interface CreateIngresoPayload {
  reference?: string
  notes?: string
  lines: Array<{ product_id: number; quantity: string | number; unit_cost?: string | number }>
}

export interface CreateEgresoPayload {
  reference?: string
  notes?: string
  lines: Array<{ product_id: number; quantity: string | number; unit_price?: string | number }>
}
